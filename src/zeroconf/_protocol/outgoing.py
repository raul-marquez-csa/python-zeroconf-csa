...
class DNSOutgoing:
    ...
    def is_query(self) -> bool:
        # print("\n\tDNSOutgoing is_query\n")
        """Returns true if this is a query."""
        return (self.flags & _FLAGS_QR_MASK) == _FLAGS_QR_QUERY

    def is_response(self) -> bool:
        # print("\n\tDNSOutgoing is_response\n")
        """Returns true if this is a response."""
        return (self.flags & _FLAGS_QR_MASK) == _FLAGS_QR_RESPONSE

    def _reset_for_next_packet(self) -> None:
        # print("\n\tDNSOutgoing _reset_for_next_packet\n")
        self.names = {}
        self.data = []
    ...
    def add_question(self, record: DNSQuestion) -> None:
        print(f"\n\tDNSOutgoing add_question {record}\n")
        """Adds a question"""
    ...
    def add_authorative_answer(self, record: DNSPointer) -> None:
        # print("\n\tDNSOutgoing add_authorative_answer\n")
        """Adds an authoritative answer"""
        self.authorities.append(record)

    def add_additional_answer(self, record: DNSRecord) -> None:
        # print("\n\tDNSOutgoing add_additional_answer\n")
    ...
    def _insert_short_at_start(self, value: int_) -> None:
        # print("\n\tDNSOutgoing _insert_short_at_start\n")
    ...
    def write_character_string(self, value: bytes) -> None:
        # print("\n\tDNSOutgoing write_character_string\n")
        if TYPE_CHECKING:
            assert isinstance(value, bytes)
        length = len(value)
        if length > 256:
    ...
    def _write_link_to_name(self, index: int_) -> None:
        # print("\n\tDNSOutgoing _write_link_to_name\n")
    ...
    def _check_data_limit_or_rollback(self, start_data_length: int_, start_size: int_) -> bool:
        # print("\n\tDNSOutgoing _check_data_limit_or_rollback\n")
    ...
    def _write_questions_from_offset(self, questions_offset: int_) -> int:
        # print("\n\tDNSOutgoing _write_questions_from_offset\n")
        questions_written = 0
    ...
    def _write_answers_from_offset(self, answer_offset: int_) -> int:
        # print("\n\tDNSOutgoing _write_answers_from_offset\n")
        answers_written = 0
    ...
    def _write_records_from_offset(self, records: Sequence[DNSRecord], offset: int_) -> int:
        # print("\n\tDNSOutgoing _write_records_from_offset\n")
        records_written = 0
